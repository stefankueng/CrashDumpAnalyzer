    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DumpCallstackId = table.Column<int>(type: "INTEGER", nullable: false)
                    ...
                    CleanCallstack = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DumpCallstack", x => x.DumpCallstackId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DumpFileInfo", x => x.DumpFileInfoId);
                    table.ForeignKey(
                        name: "FK_DumpFileInfo_DumpCallstack_DumpCallstackId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DumpFileInfo_DumpCallstackId",
                table: "DumpFileInfo",
